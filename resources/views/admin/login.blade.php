...
<head>
    ...
    <link href="{{ asset('public/admin/sbadmin2/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet"
        type="text/css">
    <link
    ...
    <link href="{{ asset('public/admin/sbadmin2/css/sb-admin-2.min.css') }}" rel="stylesheet">
    ...
    <script src="{{ asset('public/admin/sbadmin2/vendor/jquery/jquery.min.js') }}"></script>
    <script src="{{ asset('public/admin/sbadmin2/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>

    <!-- Core plugin JavaScript-->
    <script src="{{ asset('public/admin/sbadmin2/vendor/jquery-easing/jquery.easing.min.js') }}"></script>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 d-none d-lg-block text-center">
                                <img src="{{ asset(config('custom.images.logo')) }}" alt="">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="{{ route('admin.post.login') }}" class="user" method="POST" data-parsley-validate>
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="name" class="form-control form-control-user" placeholder="Tên đăng nhập" required data-parsley-required-message="Trường này không được bỏ trống.">
                                        </div>
                                        <div class="form-group">
