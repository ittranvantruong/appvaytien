...
@section('title', 'Quản lý khoản vay ước tính')
@push('css')
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12 col-md-4">
            <div class="card">
                <div class="card-header">
                    <h4 class="text-center">Thêm khoản vay</h4>
                </div>
                <div class="card-body">
                    <form id="formAdd" action="{{ route('admin.loan.amount.store') }}" method="post" data-parsley-validate>
                        @csrf
                        <div class="form-group">
                            <label for="">Khoản vay</label>
                            <input type="text" name="name" class="form-control" placeholder="Nhập tên khoản vay" required
        ...
        <div class="col-12 col-md-8">
            <form id="formMultiple" action="{{ route('admin.loan.amount.multiple') }}" method="post">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <h4>Danh sách khoản vay</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    @foreach ($loan_amount as $item)
                                        @include('admin.loan_amount.row', ['item' => $item])
                                    @endforeach
                                </tbody>
                            </table>
                        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formUpdate" action="{{ route('admin.loan.amount.update') }}" method="post"
...
<script src="{{  asset('public/admin/js/loan_amount.js') }}"></script>

<script>
    $(document).ready(function () {
        customDatatable('.table', [0, 3]);
    });
</script>
