...
<body>
    <div>
        ...
        <p>Ngày kí hợp đồng: {{ $data['created_at'] }}</p>
        <p>Số tiền vay: {{ number_format($data['loan_limit']) }} vnđ</p>
        <p>Vay trong thời gian: {{ $data['loan_period'] }}</p>
        ...
        <p>TIỀN GỐC ( Chỉ số tiền bên A cho vay): {{ number_format($data['loan_limit']) }} vnđ</p>
        ...
        <p>_ Ngày đăng ký vay là: {{ $data['created_at'] }}%</p>
